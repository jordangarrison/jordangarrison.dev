...
export const toolsProjects: PortfolioProject[] = [
	...
	},
	{
		id: 2,
		title: 'hubctl',
		description: 'A comprehensive CLI tool for GitHub Enterprise administration with full API integration, multiple output formats, and interactive prompts.',
		...
		features: ['Full GitHub API integration', 'Multiple output formats: table, JSON, list', 'Interactive prompts and confirmations', 'Batch operations support', 'Enterprise-ready authentication']
	},
	{
		id: 3,
		title: 'whats-my-status',
		description: 'Multi-platform CLI tool to set your status on Slack and GitHub simultaneously from the command line.',
		...
		features: ['Multi-platform support (Windows, macOS, Linux)', 'Slack and GitHub status sync', 'Custom status aliases', 'Time-based expiration', 'YAML configuration']
	},
	{
		id: 11,
		title: 'vitals',
		description: 'Personal health data explorer - import, visualize, and own your health data from multiple sources.',
		githubUrl: 'https://github.com/jordangarrison/vitals',
		liveUrl: null,
		downloadUrl: null,
		techStack: ['TypeScript', 'Bun', 'Elysia', 'htmx', 'SQLite'],
		features: ['Import 4.6M+ Apple Health records', 'MacroFactor nutrition analysis with 52 micronutrients', 'Interactive charts for 100+ health metrics', 'Workout GPS route visualization with Leaflet.js', 'ECG waveform display and FHIR clinical records', 'Multi-user support, self-hosted and privacy-focused']
	},
	{
		id: 12,
		title: 'sweet-nothings',
		description: 'Whisper sweet nothings to your Linux computer - terminal-based dictation tool powered by whisper.cpp.',
...
export const nixProjects: PortfolioProject[] = [
	{
		id: 4,
		title: 'nix-config',
		description: 'My personal nix configurations for the computers I use.',
	...
	},
	{
		id: 5,
		title: 'nix-packages',
		description: 'Custom Nix packages and overlays for software not yet in nixpkgs or requiring custom configurations.',
		githubUrl: 'https://github.com/jordangarrison/nix-packages',
		liveUrl: null,
		downloadUrl: null,
		techStack: ['Nix', 'Flakes', 'Packaging'],
		features: ['Custom package definitions', 'Flakes-based distribution', 'Easy to consume as overlay', 'Reproducible builds']
	},
	{
		id: 6,
		title: 'warp-preview-flake',
		description: 'Warp Terminal (preview) packaged from .deb on NixOS. Bringing modern terminal tools to the Nix ecosystem.',
		githubUrl: 'https://github.com/jordangarrison/warp-preview-flake',
		liveUrl: null,
		downloadUrl: null,
		techStack: ['Nix', 'Flakes', 'Packaging'],
		features: ['Warp Terminal on NixOS', 'Automated .deb extraction', 'Flake-based installation', 'Preview version tracking']
	},
	{
		id: 7,
		title: 'aws-tools',
		description: 'A collection of CLI utilities for working with AWS services, packaged with Nix for reproducible environments.',
		githubUrl: 'https://github.com/jordangarrison/aws-tools',
		liveUrl: null,
		downloadUrl: null,
		techStack: ['Python', 'AWS', 'Nix', 'CLI'],
		features: ['Multiple AWS service utilities', 'Nix-packaged for reproducibility', 'SSO-friendly workflows', 'Scripting-ready design']
	},
	{
		id: 8,
		title: 'aws-use-sso',
...
export const aiProjects: PortfolioProject[] = [
	{
		id: 9,
		title: 'agents',
		description: 'Personal micro agents for productivity - agentic tools are the new dotfiles.',
		githubUrl: 'https://github.com/jordangarrison/agents',
		liveUrl: null,
		downloadUrl: null,
		techStack: ['TypeScript', 'Claude', 'Claude Code', 'Shell', 'Nix'],
		features: ['Composable micro agents', 'AI-powered productivity tools', 'Personal automation workflows', 'MCP integration', 'Extensible design']
	},
	{
		id: 10,
		title: 'let-me-gpt-that-for-you',
		description: "A clone of 'Let me Google that for you' but for AI chats. Create shareable links with pre-filled prompts for ChatGPT, Gemini, and Claude.",
		...
		features: ['Multiple AI providers supported', 'Shareable pre-filled prompt links', 'Realistic chat simulation', 'Responsive modern UI']
	},
	{
		id: 13,
		title: 'wiggle-puppy',
		description: 'A Ralph Wiggum loop implementation - autonomous AI agent loop runner that repeatedly executes an AI agent until task completion.',
